...
class SendByEmailListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
		...
		// TODO: Crear un servicio exclusivo para enviar emails 
		// y evitar incluir dependencias al paquete client.
		//EMailDialog emd = new EMailDialog ((JFrame)jasperViewer,Msg.getMsg(Env.getCtx(), "SendMail"),from, to, subject, message, attachment);
    }
}
